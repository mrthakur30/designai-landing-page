...
const Header: React.FC = () => {
    ...
    return (
        <div className="fixed z-50 max-w-full hover:bg-green-300 p-3 px-4 mx-5 my-2 rounded-full shadow border-white backdrop-blur-lg">
        <div className="container flex items-center justify-evenly">
            <div className="flex md:gap-3 items-center justify-center gap-2 font-semibold text-xl md:text-2xl">
                ...
                <h1 className=" text-zinc-800 text-center">Design AI</h1>
            </div>

            <button type="button" className="text-white border-2 md:text-xl ml-5 font-semibold border-green-1 grid justify-items-center bg-green-1 p-2.5 px-4 rounded-full ">
